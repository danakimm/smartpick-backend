...
4. 각 항목은 최대 3단어 이내의 간결한 키워드로 표현 (예: "매우 선명한 디스플레이" → "선명한 디스플레이")
5. 긍정/부정 측면을 모두 고려하되, 균형 있게 표현 (예: "저장 공간" 항목에 대해 "충분한 저장 공간"과 "저장 공간 부족" 모두 고려)
